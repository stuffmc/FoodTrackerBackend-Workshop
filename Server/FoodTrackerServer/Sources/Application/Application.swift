...
public func initialize() throws {
    print("••• STARTING •••")
//    let info = Connection.ConnectionInfo(uri: URL("mysql://localhost:5432/database_name")!)!
...
//    try connection.open()
    ...
    initializeSwaggerRoute(path: ConfigurationManager.BasePath.project.path + "/definitions/FoodTrackerServer.yaml")
